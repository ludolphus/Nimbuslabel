...
/* added from NISDKAvailability.m */
BOOL NIIsPad(void) {
...
/* added from NIFoundationMethods.h */
/**
...
/* Added from NINonEmptyCollectionTesting.m */
BOOL NIIsArrayWithObjects(id object) {
    return [object isKindOfClass:[NSArray class]] && [(NSArray*)object count] > 0;
}

/* Added from NIDebuggingTools.m */
BOOL NIDebugAssertionsShouldBreak = YES;

/* Added from NIDebuggingTools.h */
